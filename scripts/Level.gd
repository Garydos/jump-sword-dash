...
export (Vector2) var checkpoint1spawn
...
export (String) var nextLevel = "Main.tscn"
export (String) var currentLevel = "Level.tscn"
export (String) var prevLevel
...
func _on_ResetTimer_timeout():
    $ResetTimer.stop()
    get_tree().change_scene("res://scenes/" + currentLevel)
